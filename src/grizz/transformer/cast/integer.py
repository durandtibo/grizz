r"""Contain ``polars.DataFrame`` transformers to convert integer columns
to a new data type."""

from __future__ import annotations

__all__ = ["InplaceIntegerCastTransformer", "IntegerCastTransformer"]
...
class IntegerCastTransformer(CastTransformer):
    r"""Implement a transformer to convert integer columns to a new data
    type.
...
class InplaceIntegerCastTransformer(InplaceCastTransformer):
    r"""Implement a transformer to convert integer columns to a new data
    type.
