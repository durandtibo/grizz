...
from grizz.lazy.transformer.columns import BaseIn1Out1Transformer
...
class ReplaceTransformer(BaseIn1Out1Transformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import Replace
...
class InplaceReplaceTransformer(ReplaceTransformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import InplaceReplace
...
class ReplaceStrictTransformer(BaseIn1Out1Transformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import ReplaceStrict
...
class InplaceReplaceStrictTransformer(ReplaceStrictTransformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import InplaceReplaceStrict
