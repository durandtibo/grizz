# noqa: A005
r"""Contain ``polars.LazyFrame`` transformers to process string
values."""
...
from grizz.lazy.transformer.columns import BaseInNOutNTransformer
...
class StripCharsTransformer(BaseInNOutNTransformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import StripChars
...
class InplaceStripCharsTransformer(StripCharsTransformer):
    ...
    >>> import polars as pl
    >>> from grizz.lazy.transformer import InplaceStripChars
