...
def test_replace_transformer_fit_transform() -> None:
    ...
    assert_frame_equal(
        out, pl.LazyFrame({"old": ["a", "b", "c", "d", "e"], "new": ["1", "2", "3", "d", "e"]})
    )
...
def test_replace_transformer_transform_same_column() -> None:
    ...
    frame = pl.LazyFrame({"col": ["a", "b", "c", "d", "e"]})
    out = transformer.transform(frame)
    assert_frame_equal(out, pl.LazyFrame({"col": ["1", "2", "3", "d", "e"]}))
...
def test_replace_strict_transformer_fit_transform() -> None:
    ...
    out = transformer.fit_transform(frame)
    assert_frame_equal(
        out, pl.LazyFrame({"old": ["a", "b", "c", "d", "e"], "new": [1, 2, 3, 4, 5]})
    )
...
def test_replace_strict_transformer_transform_mapping_default() -> None:
    ...
    out = transformer.transform(frame)
    assert_frame_equal(
        out, pl.LazyFrame({"old": ["a", "b", "c", "d", "e"], "new": [1, 2, 3, None, None]})
    )
...
def test_replace_strict_transformer_transform_same_column() -> None:
    ...
    frame = pl.LazyFrame({"col": ["a", "b", "c", "d", "e"]})
    out = transformer.transform(frame)
    assert_frame_equal(out, pl.LazyFrame({"col": [1, 2, 3, 4, 5]}))
...
def test_inplace_replace_strict_transformer_transform_mapping_default() -> None:
    ...
    frame = pl.LazyFrame({"col": ["a", "b", "c", "d", "e"]})
    out = transformer.transform(frame)
    assert_frame_equal(out, pl.LazyFrame({"col": [1, 2, 3, None, None]}))
