...
def test_cast_transformer_transform_1_col(dataframe: pl.DataFrame) -> None:
...
def test_cast_transformer_transform_2_cols(dataframe: pl.DataFrame) -> None:
...
def test_cast_transformer_transform_3_cols(dataframe: pl.DataFrame) -> None:
